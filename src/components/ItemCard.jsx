...
export default function ItemCard({item, addItem}) {
        ...
        <div className="itemCard">
            ...
            <div className="itemCartOptions">
                ...
                <div className="itemAmountSelect">
                    ...
                    <input type="number" step="1" min="1" value={amount} onBlur={() => handleBlur()} onChange={(e) => handleChange(e)}/>
                    <button className="amountButton">
                        <CircleArrowRight
            ...
            <div className="itemButton">
                ...
                <button
                    onClick={() => addItem({id: item.id, amount: amount})}
                >
                    Add to Cart
                </button>
            </div>
